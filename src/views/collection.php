...
<head>
	<title>Lucos Media Metadata Manager -
...
?>
	...
	$prevpage = $page - 1;
	if ($prevpage > 0) {
?><a href="<?= htmlspecialchars(" /collections/" . urlencode($data["slug"]) . "?page={$prevpage}")?>">&lt;- Prev</a> |
			<?php
	}
?>
			Page
...
?>
			| <a href="<?= htmlspecialchars(" /collections/" . urlencode($data["slug"]) . "?page={$nextpage}")?>">Next
				-&gt;</a>
			<?php
	}
?>
